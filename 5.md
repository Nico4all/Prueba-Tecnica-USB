...
En su lugar se implementa un **borrado lógico o softdelete**, utilizando un campo como `estado` o `fecha_retiro`.
...
Dependiendo del grande del proyecto tambien utilizaria **NestJS** por su estructura y escalabilidad.